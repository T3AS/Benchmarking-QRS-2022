...
from ray.rllib.agents.ppo.ppo_tf_policy import PPOTFPolicy #0.8.4 - 0.8.7
...
if args.debug:
        ...
        config= {
                   ...
                   "num_sgd_iter": 4,  # Enables Experience Replay
                    "multiagent": {
                        ...
                        "policy_mapping_fn":
                        tune.function(lambda agent_id: agent_id),
                        "policies_to_train": ["carPPO"], #car2PPO is Autonomous driving models
                    },
                    "env_config": env_actor_configs,
                    "num_workers": args.num_workers,
                    "num_envs_per_worker": args.envs_per_worker,
    ...
    #                     "policy_mapping_fn":
    #                     tune.function(lambda agent_id: agent_id),
    #                     "policies_to_train": ["car2PPO"], #car2PPO is Autonomous driving models
    #                 },
    #                 "env_config": env_actor_configs,
    #                 "num_workers": args.num_workers,
    #                 "num_envs_per_worker": args.envs_per_worker,
