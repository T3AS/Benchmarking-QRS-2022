...
# Used only in debug mode
env_name_3 = "A2C_roundabout_train-v0"
...
agents_reward_dict = {'carA2C': 0.0,}
done = False
i=0
action = {}
with open("info_carA2C.json", "w") as f1:
