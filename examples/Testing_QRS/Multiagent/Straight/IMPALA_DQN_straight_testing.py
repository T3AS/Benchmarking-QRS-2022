...
parser.add_argument(
    "--checkpoint-path6",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DQN/Straight/DQN_Straight/DQN_DQN_straight_train-v0_0_2022-08-19_09-06-122colixno/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")   
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/MA-Inde-PPO-A2C-Scenario-2-SSUI3CCARLA/MultiAgent_IMPALA_DQN_straight_train-v0_0_2022-08-25_11-25-05uuab_4rp/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name_5 = "IMPALA_straight_train-v0"
...
# Used only in debug mode
env_name_6 = "DQN_straight_train-v0"
...
# Used only in debug mode
env_name_7 = "IMPALA_DQN_straight_train-v0"
...
def env_creator_6(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DQN_straight_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("IMPALA_DQN_straight_train-v0")
