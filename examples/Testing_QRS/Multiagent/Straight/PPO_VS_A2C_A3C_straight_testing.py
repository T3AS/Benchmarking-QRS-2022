...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/PPO/Straight/PPO_Straight/PPO_PPO_straight_train-v0_0_2022-08-16_15-05-39zsyfs4r5/checkpoint_50/checkpoint-50',    
...
parser.add_argument(
    "--checkpoint-path3",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/A3C/Straight/A3C_Straight/A3C_A3C_straight_train-v0_0_2022-08-17_15-00-56bdvy79iq/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training") 
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/PPO-A2C-A3C-Straight/MultiAgent_PPO_A2C_A3C_straight_train-v0_0_2022-08-25_08-42-22nfxhsqs5/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "PPO_straight_train-v0"
...
# Used only in debug mode
env_name_2 = "A2C_straight_train-v0"
...
# Used only in debug mode
env_name_3 = "A3C_straight_train-v0"
...
# Used only in debug mode
env_name_7 = "PPO_A2C_A3C_straight_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("PPO_straight_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("A2C_straight_train-v0")
...
def env_creator_3(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("A3C_straight_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("PPO_A2C_A3C_straight_train-v0")
