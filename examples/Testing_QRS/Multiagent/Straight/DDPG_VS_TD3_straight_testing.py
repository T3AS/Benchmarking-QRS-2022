...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DDPG/Straight/DDPG_Straight/DDPG_DDPG_straight_train-v0_0_2022-08-19_13-20-22ui3gpnac/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path2",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/TD3/Straight/TD3_Straight/DDPG_TD3_straight_train-v0_0_2022-08-20_09-36-559mdfqgr7/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/DDPG-TD3-Straight/MultiAgent_DDPG_TD3_straight_train-v0_0_2022-08-27_09-18-53we5gi4sn/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "DDPG_straight_train-v0"
...
# Used only in debug mode
env_name_2 = "TD3_straight_train-v0"
...
# Used only in debug mode
env_name_7 = "DDPG_TD3_straight_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("DDPG_straight_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("TD3_straight_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DDPG_TD3_straight_train-v0")
