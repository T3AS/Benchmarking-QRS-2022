...
parser.add_argument(
    "--checkpoint-path5",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/IMPALA/Three_way/IMPALA_Three_way/MultiAgent_IMPALA_three_way_train-v0_0_2022-08-18_14-30-31ve4csnjd/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path6",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DQN/Three_way/DQN_Three_way/DQN_DQN_three_way_train-v0_0_2022-08-19_09-51-131grf2tzt/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")   
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/IMPALA_DQN_three_way/MultiAgent_IMPALA_DQN_three_way_train-v0_0_2022-08-29_09-08-14rze5x5rx/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name_5 = "IMPALA_three_way_train-v0"
...
# Used only in debug mode
env_name_6 = "DQN_three_way_train-v0"
...
# Used only in debug mode
env_name_7 = "IMPALA_DQN_three_way_train-v0"
...
def env_creator_5(env_config):
    ...
    import macad_gym
    env = gym.make("IMPALA_three_way_train-v0")
...
def env_creator_6(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DQN_three_way_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("IMPALA_DQN_three_way_train-v0")
