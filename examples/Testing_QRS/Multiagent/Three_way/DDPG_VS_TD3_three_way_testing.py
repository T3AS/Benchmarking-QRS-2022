...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DDPG/Three_way/DDPG_Three_way/DDPG_DDPG_three_way_train-v0_0_2022-08-19_15-03-31919q1q0k/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path2",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/TD3/Three_way/TD3_Three_way/DDPG_TD3_three_way_train-v0_0_2022-08-20_10-20-12qc65nxaa/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/DDPG-TD3-three_way/MultiAgent_DDPG_TD3_three_way_train-v0_0_2022-08-29_10-03-51_t6u1mvn/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "DDPG_three_way_train-v0"
...
# Used only in debug mode
env_name_2 = "TD3_three_way_train-v0"
...
# Used only in debug mode
env_name_7 = "DDPG_TD3_three_way_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("DDPG_three_way_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("TD3_three_way_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DDPG_TD3_three_way_train-v0")
