...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DDPG/Four_way/DDPG_Four_way/DDPG_DDPG_four_way_train-v0_0_2022-08-19_15-45-31bnzp8drq/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path2",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/TD3/Four_way/TD3_Four_way/DDPG_TD3_four_way_train-v0_0_2022-08-20_11-02-521k2yt3iu/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/DDPG-TD3-four_way/MultiAgent_DDPG_TD3_four_way_train-v0_0_2022-08-29_14-38-45n60qaf7l/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "DDPG_four_way_train-v0"
...
# Used only in debug mode
env_name_2 = "TD3_four_way_train-v0"
...
# Used only in debug mode
env_name_7 = "DDPG_TD3_four_way_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("DDPG_four_way_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("TD3_four_way_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DDPG_TD3_four_way_train-v0")
