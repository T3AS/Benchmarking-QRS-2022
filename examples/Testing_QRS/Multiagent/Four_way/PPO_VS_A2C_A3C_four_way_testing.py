...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/PPO/Four_way/PPO_Four_way/PPO_PPO_four_way_train-v0_0_2022-08-16_17-48-161lhtzuoc/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path2",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/A2C/Four_way/A2C_Four_way/A2C_A2C_four_way_train-v0_0_2022-08-17_12-43-572xqsep9t/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path3",
    #Replace it with your path of last training checkpoints
...
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/PPO-A2C-A3C-Four_way/MultiAgent_PPO_A2C_A3C_four_way_train-v0_0_2022-08-29_11-25-16vsvxm1h6/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "PPO_four_way_train-v0"
...
# Used only in debug mode
env_name_2 = "A2C_four_way_train-v0"
...
# Used only in debug mode
env_name_7 = "PPO_A2C_A3C_four_way_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("PPO_four_way_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("A2C_four_way_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("PPO_A2C_A3C_four_way_train-v0")
