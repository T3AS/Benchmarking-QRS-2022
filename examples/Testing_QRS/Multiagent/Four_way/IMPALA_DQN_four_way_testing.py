...
parser.add_argument(
    "--checkpoint-path5",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/IMPALA/Four_way/IMPALA_Four_way/MultiAgent_IMPALA_four_way_train-v0_0_2022-08-18_15-13-56zk3_i_g3/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path6",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DQN/Four_way/DQN_Four_way/DQN_DQN_four_way_train-v0_0_2022-08-19_10-34-4581_bt43q/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")   
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/IMPALA_DQN_four_way/MultiAgent_IMPALA_DQN_four_way_train-v0_0_2022-08-29_13-43-44c97118lf/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name_5 = "IMPALA_four_way_train-v0"
...
# Used only in debug mode
env_name_6 = "DQN_four_way_train-v0"
...
# Used only in debug mode
env_name_7 = "IMPALA_DQN_four_way_train-v0"
...
def env_creator_5(env_config):
    ...
    import macad_gym
    env = gym.make("IMPALA_four_way_train-v0")
...
def env_creator_6(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("DQN_four_way_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("IMPALA_DQN_four_way_train-v0")
...
def default_policy_5():
    env_actor_configs_5["env"]["render"] = False
...
def default_policy_6():
    env_actor_configs_6["env"]["render"] = False
...
policyDQN = new_trainer_6.get_policy("carDQN")
...
policyIMPALA = new_trainer_5.get_policy("carIMPALA")
...
trainer.get_policy("carIMPALA").set_weights(weights_as_np_IMPALA)
trainer.get_policy("carDQN").set_weights(weights_as_np_DQN)
...
agents_reward_dict = {'carIMPALA': 0.0, 'carDQN': 0.0}
done = False
i=0
action = {}
with open("info_carIMPALA.json", "w") as f5, open("info_carDQN.json", "w") as f6 :
    ...
    while i < 5000:  # number of steps in a episodic run 
        ...
        step_reward=0
        step_reward += reward["carIMPALA"]+reward["carDQN"]
        ...
        episode_reward += reward["carIMPALA"]+reward["carDQN"]
