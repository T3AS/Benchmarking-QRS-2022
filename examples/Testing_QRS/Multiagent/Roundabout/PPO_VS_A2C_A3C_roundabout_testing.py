...
parser.add_argument(
    ...
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/PPO/Roundabout/PPO_Roundabout/PPO_PPO_roundabout_train-v0_0_2022-08-17_08-46-05f5e1rylj/checkpoint_50/checkpoint-50',    
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path2",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/A2C/Roundabout/A2C_Roundabout/A2C_A2C_roundabout_train-v0_0_2022-08-17_13-36-28y9nh5r1s/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path3",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/A3C/Roundabout/A3C_Roundabout/A3C_A3C_roundabout_train-v0_0_2022-08-18_09-47-38pz11smuf/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training") 
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/PPO-A2C-A3C-Roundabout/MultiAgent_PPO_A2C_A3C_roundabout_train-v0_0_2022-08-29_16-22-06jj13doh8/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name = "PPO_roundabout_train-v0"
...
# Used only in debug mode
env_name_2 = "A2C_roundabout_train-v0"
...
# Used only in debug mode
env_name_3 = "A3C_roundabout_train-v0"
...
# Used only in debug mode
env_name_7 = "PPO_A2C_A3C_roundabout_train-v0"
...
def env_creator(env_config):
    ...
    import macad_gym
    env = gym.make("PPO_roundabout_train-v0")
...
def env_creator_2(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("A2C_roundabout_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("PPO_A2C_A3C_roundabout_train-v0")
