...
parser.add_argument(
    "--checkpoint-path5",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/IMPALA/Roundabout/IMPALA_Roundabout/MultiAgent_IMPALA_roundabout_train-v0_0_2022-08-18_16-09-14bco2p9dt/checkpoint_50/checkpoint-50',  
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--checkpoint-path6",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/Desktop/PhD-20210325T090933Z-001/PhD/10_August_2022/Benchmarking-Archive/examples/Training_QRS/DQN/Roundabout/DQN_Roundabout/DQN_DQN_roundabout_train-v0_0_2022-08-19_11-17-0098iw29mk/checkpoint_50/checkpoint-50',
    help="Path to checkpoint to resume training")   
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/IMPALA_DQN-Roundabout/MultiAgent_IMPALA_DQN_roundabout_train-v0_0_2022-08-30_10-16-459yka13r0/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name_5 = "IMPALA_roundabout_train-v0"
...
# Used only in debug mode
env_name_6 = "DQN_roundabout_train-v0"
...
# Used only in debug mode
env_name_7 = "IMPALA_DQN_roundabout_train-v0"
...
def env_creator_5(env_config):
    ...
    import macad_gym
    env = gym.make("IMPALA_roundabout_train-v0")
...
def env_creator_7(env_config):
    ...
    # curriculum learning or joint training experiments
    import macad_gym
    env = gym.make("IMPALA_DQN_roundabout_train-v0")
