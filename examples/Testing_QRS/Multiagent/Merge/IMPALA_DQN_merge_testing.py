...
parser.add_argument(
    "--checkpoint-path7",
    #Replace it with your path of last training checkpoints
    default='/home/aizaz/ray_results/IMPALA_DQN-Merge/MultiAgent_IMPALA_DQN_merge_train-v0_0_2022-08-30_14-39-14ungnf9lk/checkpoint_1/checkpoint-1',
    help="Path to checkpoint to resume training")
parser.add_argument(
    "--disable-comet",
    action="store_true",
...
env_name_5 = "IMPALA_merge_train-v0"
