...
# Used only in debug mode
env_name_3 = "TD3_roundabout_train-v0"
...
agents_reward_dict = {'carTD3': 0.0}
done = False
i=0
action = {}
with open("info_carTD3.json", "w") as f1:
