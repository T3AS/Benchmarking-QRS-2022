...
# Used only in debug mode
env_name_3 = "PPO_roundabout_train-v0"
...
agents_reward_dict = {'carPPO': 0.0}
done = False
i=0
action = {}
with open("info_carPPO.json", "w") as f1:
