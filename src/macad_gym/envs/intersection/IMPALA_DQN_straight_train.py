...
class IMPALA_DQN_straight_train(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "Straight_IMPALA_DQN",
            "env": {
        ...
        super(IMPALA_DQN_straight_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = IMPALA_DQN_straight_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
