...
class PPO_A2C_A3C_four_way_train(MultiCarlaEnv):
    """A 4-way signalized intersection with 1 Bike, 2 Cars, 1 Pedestrian"""
    def __init__(self):
        self.configs = {
            "scenarios": "Four_Way_PPO_A2C_A3C",
            "env": {
        ...
        super(PPO_A2C_A3C_four_way_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_A2C_A3C_four_way_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
