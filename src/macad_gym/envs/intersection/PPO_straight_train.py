    ...
    def __init__(self):
        self.configs = {
            ...
            "env": {
                ...
                "spectator_loc": [99, 194.75999450683594,35],
                "sync_server": True,
        ...
        super(PPO_straight_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_straight_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
