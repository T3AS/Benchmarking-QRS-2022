...
class Experimental(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_Experimental",
            "env": {
                ...
                "spectator_loc": [97, 194.75999450683594,110],
                #[-97.20802307128906,  -3.1172239780426025, 150], #merge
                # [26.053409576416016,  -8.547677040100098, 110], #roundabout
                #[80.0, -132.8, 50],#[170.5, 70, 50], # for side pole view use [140, 68, 9],
                "sync_server": True,
        ...
        super(Experimental, self).__init__(self.configs)
