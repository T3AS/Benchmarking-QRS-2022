...
class UrbanSignalIntersection3CarTD3(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_TD3",
            "env": {
        ...
        super(UrbanSignalIntersection3CarTD3, self).__init__(self.configs)



if __name__ == "__main__":
    env = UrbanSignalIntersection3CarTD3()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
