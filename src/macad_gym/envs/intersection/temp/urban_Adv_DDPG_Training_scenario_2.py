...
class UrbanAdvDDPGTrainingScenario2(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_Adv_DDPG_Scenario_2",
            "env": {
                ...
                "spectator_loc": [80.0, -132.8, 50],#[170.5, 70, 50], # for side pole view use [140, 68, 9],
                "sync_server": True,
        ...
        super(UrbanAdvDDPGTrainingScenario2, self).__init__(self.configs)


if __name__ == "__main__":
    env = UrbanAdvDDPGTrainingScenario2()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
