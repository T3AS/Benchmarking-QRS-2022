...
class UrbanSignalIntersection3CarExtra(MultiCarlaEnv):
    ...
    def __init__(self):
        ...
        super(UrbanSignalIntersection3CarExtra, self).__init__(self.configs)



if __name__ == "__main__":
    env = UrbanSignalIntersection3CarExtra()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
