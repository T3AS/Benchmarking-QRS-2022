...
class UrbanA3CTrainingContinuous(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_A3C",
            "env": {
        ...
        super(UrbanA3CTrainingContinuous, self).__init__(self.configs)


if __name__ == "__main__":
    env = UrbanA3CTrainingContinuous()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
