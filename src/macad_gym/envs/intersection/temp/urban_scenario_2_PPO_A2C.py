...
class UrbanScenario2PPOA2C(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_MultiAgent_2",
            "env": {
        ...
        super(UrbanScenario2PPOA2C, self).__init__(self.configs)


if __name__ == "__main__":
    env = UrbanScenario2PPOA2C()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
