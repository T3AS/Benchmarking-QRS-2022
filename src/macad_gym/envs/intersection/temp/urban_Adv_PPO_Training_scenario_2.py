...
class UrbanAdvPPOTrainingScenario2(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_Adv_PPO_Scenario_2",
            "env": {
        ...
        super(UrbanAdvPPOTrainingScenario2, self).__init__(self.configs)


if __name__ == "__main__":
    env = UrbanAdvPPOTrainingScenario2()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
