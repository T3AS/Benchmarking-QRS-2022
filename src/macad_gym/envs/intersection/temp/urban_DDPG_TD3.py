...
class UrbanDDPGTD3(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "SUIC3_TOWN3_MultiAgent_DDPG",
            "env": {
                ...
                "spectator_loc": [85.0, -126, 80],#[80.0, -132.8, 50],#[170.5, 70, 50], # for side pole view use [140, 68, 9],
                "sync_server": True,
        ...
        super(UrbanDDPGTD3, self).__init__(self.configs)
