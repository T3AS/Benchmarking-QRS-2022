    ...
    def __init__(self):
        self.configs = {
            ...
            "env": {
                ...
                "spectator_loc": [26.053409576416016,  -8.547677040100098, 50],
                "sync_server": True,
        ...
        super(PPO_roundabout_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_roundabout_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
