...
class PPO_A2C_four_way(MultiCarlaEnv):
    ...
    def __init__(self):
        ...
        super(PPO_A2C_four_way, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_A2C_four_way()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
