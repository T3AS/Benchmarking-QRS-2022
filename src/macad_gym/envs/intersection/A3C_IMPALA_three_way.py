...
class A3C_IMPALA_three_way(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "Three_Way_A3C_IMPALA",
            "env": {
            ...
            "actors": {
                ...
                "pedestrian1": {
                    "type": "vehicle_2W", #change to pedestrian when running test
                    "enable_planner": False,
                    "convert_images_to_video": False,
                    "early_terminate_on_collision": True,
                    "reward_function": "custom",
        ...
        super(A3C_IMPALA_three_way, self).__init__(self.configs)


if __name__ == "__main__":
    env = A3C_IMPALA_three_way()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
