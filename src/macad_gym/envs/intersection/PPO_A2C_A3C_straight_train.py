...
class PPO_A2C_A3C_straight_train(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "Straight_PPO_A2C_A3C",
            "env": {
                ...
                "spectator_loc": [97, 194.75999450683594,20],
                "sync_server": True,
        ...
        super(PPO_A2C_A3C_straight_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_A2C_A3C_straight_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
