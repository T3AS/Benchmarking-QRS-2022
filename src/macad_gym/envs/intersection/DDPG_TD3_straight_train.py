...
class DDPG_TD3_straight_train(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "Straight_DDPG_TD3",
            "env": {
        ...
        super(DDPG_TD3_straight_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = DDPG_TD3_straight_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
