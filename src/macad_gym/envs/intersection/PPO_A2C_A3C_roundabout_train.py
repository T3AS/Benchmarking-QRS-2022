...
class PPO_A2C_A3C_roundabout_train(MultiCarlaEnv):
    """A 4-way signalized intersection Multi-Agent Carla-Gym environment"""
    def __init__(self):
        self.configs = {
            "scenarios": "Roundabout_PPO_A2C_A3C",
            "env": {
        ...
        super(PPO_A2C_A3C_roundabout_train, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_A2C_A3C_roundabout_train()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
