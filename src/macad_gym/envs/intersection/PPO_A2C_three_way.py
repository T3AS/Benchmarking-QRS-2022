    ...
    def __init__(self):
        self.configs = {
            ...
            "actors": {
                ...
                "pedestrian1": {
                    "type": "pedestrian", #change to pedestrian when running test
                    "enable_planner": False,
                    "convert_images_to_video": False,
                    "early_terminate_on_collision": True,
                    "reward_function": "ped",
        ...
        super(PPO_A2C_three_way, self).__init__(self.configs)


if __name__ == "__main__":
    env = PPO_A2C_three_way()
    configs = env.configs
    for ep in range(2):
        obs = env.reset()
