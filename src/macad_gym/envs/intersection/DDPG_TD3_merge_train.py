    ...
    def __init__(self):
        self.configs = {
            ...
            "env": {
                ...
                "spectator_loc": [-97.20802307128906,  -3.1172239780426025, 100],        
                "sync_server": True,
        ...
        super(DDPG_TD3_merge_train, self).__init__(self.configs)
